  ...
  <section :id="id" class="projects-section">
    <div class="container">
      ...
      <div class="text-center q-mb-lg" data-aos="fade-up" data-aos-delay="100">
        <q-btn-group flat>
          <q-btn v-for="category in categories" :key="category.value" :label="category.label"
            :outline="selectedCategory !== category.value" :unelevated="selectedCategory === category.value"
            :color="selectedCategory === category.value ? 'primary' : 'grey-7'"
            @click="selectedCategory = category.value" class="filter-btn">
      ...
      <div class="row q-col-gutter-lg">
        <div v-for="(project, index) in filteredProjects" :key="project.id" class="col-12 col-md-6 col-lg-4"
          data-aos="fade-up" :data-aos-delay="index * 100">
          <q-card flat class="project-card bg-grey-9 full-height column cursor-pointer"
            ...
            <div class="project-thumbnail" :style="{ background: project.gradient }">
              ...
              <div class="thumbnail-overlay">
                <q-btn round color="white" text-color="grey-10" icon="visibility" size="md" />
              </div>
            </div>

            <q-card-section class="column q-pa-lg" style="flex: 1;">
              <!-- Category badge -->
              <q-badge :color="getCategoryColor(project.category)" :label="getCategoryLabel(project.category)"
                class="q-mb-sm" />
              ...
              <div class="metrics-row q-mb-md" v-if="project.metrics">
                <div v-for="metric in project.metrics" :key="metric.label" class="metric-item">
              ...
              <div class="q-mt-auto">
                ...
                <div class="row q-gutter-xs">
                  <q-chip v-for="tech in project.stack.slice(0, 4)" :key="tech" dense outline color="primary"
                    text-color="primary" size="sm">
                    {{ tech }}
                  </q-chip>
                  <q-chip v-if="project.stack.length > 4" dense outline color="grey-7" text-color="grey-4" size="sm">
              ...
              <div class="container">
                <div class="row items-center q-py-xl">
                  <div class="col-12 col-md-8">
                    <q-badge :color="getCategoryColor(selectedProject.category)"
                      :label="getCategoryLabel(selectedProject.category)" class="q-mb-md" size="lg" />
                ...
                <div class="col-12 col-md-8">
                  ...
                  <div class="q-mb-xl" v-if="selectedProject.metrics">
                    ...
                    <div class="row q-col-gutter-md">
                      <div v-for="metric in selectedProject.metrics" :key="metric.label" class="col-6 col-sm-3">
                  ...
                  <div class="q-mb-xl">
                    ...
                    <q-list>
                      <q-item v-for="(feature, idx) in selectedProject.features" :key="idx" class="q-px-none">
                  ...
                  <div class="q-mb-xl">
                    ...
                    <q-list>
                      <q-item v-for="(challenge, idx) in selectedProject.challenges" :key="idx" class="q-px-none">
                        <q-item-section avatar>
                ...
                <div class="col-12 col-md-4">
                  ...
                  <q-card flat class="bg-grey-9 q-mb-md">
                    <q-card-section>
                      ...
                      <div class="stack-tags">
                        <q-chip v-for="tech in selectedProject.stack" :key="tech" color="grey-8" text-color="grey-2"
                          size="md">
                          {{ tech }}
                        </q-chip>
                      </div>
                  ...
                  <q-card flat class="bg-grey-9">
                    <q-card-section>
                      ...
                      <div class="stack-tags">
                        <q-chip v-for="tag in selectedProject.tags" :key="tag" outline color="primary"
                          text-color="primary" size="sm">
                          {{ tag }}
                        </q-chip>
                      </div>
...
const projects: Project[] = [
  ...
  //   shortDescription: 'Sistema completo multi-empresa para emissão de notas fiscais eletrônicas com integrações de serviços fiscais, gestão de certificados e painéis administrativos.',
  //   fullDescription: 'Implementação de sistema fiscal com suporte a múltiplas empresas, emissão de NFe e NFC-e, integração com serviços fiscais de vários estados, gestão automática de certificados digitais A1 e A3, importação de produtos e painéis administrativos robustos.',
  //   category: 'fiscal',
  //   icon: 'receipt_long',
  ...
  //   type: 'Enterprise',
  //   stack: ['Node.js / Laravel', 'Vue.js', 'MySql', 'Docker', 'SEFAZ API'],
  ...
  //     'Painel administrativo completo com interface administrativa avançada',
  ...
  // },
  {
    ...
    fullDescription: 'Desenvolvimento de plataforma de automação para extrair dados de sistemas legados, com arquitetura de filas assíncronas, gerenciamento inteligente de sessões e tratamento de falhas.',
    category: 'automation',
    icon: 'smart_toy',
  ...
  },
  {
    ...
    shortDescription: 'Plataforma completa de apostas esportivas e jogos digitais com arquitetura transacional, processamento de pagamentos e gestão de prêmios.',
    ...
    period: '2025',
    type: 'iGaming',
    stack: ['Node.js', 'Laravel', 'NextJs', 'MySql', 'Redis', 'Lumen', 'Payment APIs', 'WebSockets'],
  ...
  },
  {
    ...
    period: '2023/2024',
    type: 'API Backend',
    stack: ['Laravel', 'Swagger', 'JWT', 'MySQL', 'MongoDB', 'Redis'],
  ...
  },
  {
    ...
    fullDescription: 'Desenvolvimento e otimização de sistema com integrações complexas de APIs externas, emissão de boletos bancários, lógica de negócio robusta no backend e interfaces dinâmicas. Aplicação de design patterns para melhorar performance e manutenibilidade.',
    category: 'api',
    ...
    stack: ['Laravel', 'Silex', 'jQuery', 'Ajax', 'Bootstrap', 'Postgres', 'Redis', 'APIs Externas', 'Bitbucket', 'Trello'],
    ...
    metrics: [
      { value: '30%', label: 'Aumento de desempenho' },
      { value: '5+', label: 'APIs integradas' },
      { value: '100%', label: 'Boletos Processados' },
    ]
  },
  {
    id: 6,
    ...
    period: '2025/2026',
    type: 'Dashboard',
    stack: ['Laravel', 'Vue.js', 'Vuetify', 'MySQL', 'Jenkins', 'Kafka', 'Azure Devops'],
    ...
    features: [
      ...
      'Reconstrução de relatórios de indicadores'
    ],
    challenges: [
